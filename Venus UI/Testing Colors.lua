...
local themes = {
    ...
    Violet = {
        ...
        TabBackground = Color3.fromRGB(85, 57, 139),
        Tab = Color3.fromRGB(85, 57, 139),
        EnabledText = Color3.fromRGB(255,255,255),
        DisabledText = Color3.fromRGB(180, 180, 180),
        TabToggleEnabled = Color3.fromRGB(160, 140, 180),
        TabToggleDisabled = Color3.fromRGB(0,0,128),
        TabToggleDisabledMouseOver = Color3.fromRGB(128,0,0),
        Section = Color3.fromRGB(154,205,50),
        Button = Color3.fromRGB(143,188,143),
        ButtonMouseOver = Color3.fromRGB(40, 40, 40),
        ToggleEnabled = Color3.fromRGB(179, 129, 148),
        ToggleEnabledMouseOver = Color3.fromRGB(209, 159, 178),
        ToggleDisabled = Color3.fromRGB(30, 30, 30),
