...
local library = utility.table({theme = table.clone(themes.Default), folder = "vozoiduilib", extension = "vozoid", flags = {}, open = true, keybind = Enum.KeyCode.F1, mousestate = services.InputService.MouseIconEnabled, cursor = false, holder = nil, connections = {}}, true)
