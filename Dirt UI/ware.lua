...
function Lib:CreateWindow(Name)
 ...
 Main.Name = "Main"
    ...
    glow.ImageColor3 = Color3.fromRGB(177, 136, 255)
    ...
    glow_2.ImageColor3 = Color3.fromRGB(177, 136, 255)
    ...
    function Window:Toggle(name, options, callback)
        ...
        toggle.Parent = Holder
        toggle.Active = false
        toggle.BackgroundColor3 = Color3.fromRGB(48, 255, 69)
        toggle.BackgroundTransparency = 1.000
        toggle.Selectable = false
        toggle.Size = UDim2.new(1, 0, 1, 0)
        toggle.Font = Enum.Font.GothamBold
        toggle.TextColor3 = Color3.fromRGB(48, 255, 69)
        toggle.TextSize = 12.000
        toggle.TextStrokeColor3 = Color3.fromRGB(48, 255, 69)
